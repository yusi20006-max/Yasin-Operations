...
def test_release_process_exists_and_contains_canonical_verification_order():
    ...
    assert "Python 3.11, 3.12, 3.13, and 3.14" in document
...
def test_release_evidence_contains_no_machine_specific_markers():
    evidence = (ROOT / "docs" / "RELEASE_READINESS_v0.1.0.md").read_text(encoding="utf-8")
    forbidden = ("/data/data/", "/home/", "PID", "token", "password")
