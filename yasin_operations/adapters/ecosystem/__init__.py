...
These modules depend only on Yasin-Operations contracts. Target repositories
remain independent and are never imported here.
"""

from yasin_operations.adapters.ecosystem.contracts import (
    CONTRACT_VERSION,
    AdapterResult,
